      ...
      vueApp.component(
        ...
        `,
          data() {
            return {
              expanded: false,
              configCache: extensions_default.__cache__.config[this.id]
            };
          },
          methods: {
            i18nFormat: i18n_default.format,
