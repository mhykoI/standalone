    ...
    load(vueApp) {
      vueApp.component(
        ...
        `,
          ...
          methods: {
            onStorageUpdate() {
              console.log(extensions_default.storage.installed.ghost);
