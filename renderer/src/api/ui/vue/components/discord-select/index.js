...
export default {
  ...
  load(vueApp) {
    vueApp.component("discord-select", {
      template: `
        <div class="\`acord--discord-select acord--discord-select-lookFilled acord--discord-select \${id}\`" :class="{'acord--discord-select-open': active}">
          ...
          <div v-if="active" class="\`options acord--discord-select-popout acord--discord-select-scrollerBase acord--discord-select-scrollThin \${id}\`" :class="{'top-popout': popoutPosition === 'top'}">
